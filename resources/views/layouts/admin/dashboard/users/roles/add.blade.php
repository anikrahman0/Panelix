                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <x-page-title header="Add New Role" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                ...
                                <x-breadcrumb-item active="true" url="{{ route('admin.roles.add') }}" label="Add New Role" />
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <x-form-fields.text-common inputType="text" inputName="name" inputValue="{{old('name')}}" inputRequired="true" labelText="Name" placeHolder="Name" pattern="" maxlength="100" />
                                        </div>
                                        <div class="col-xl-6">
                                            <x-form-fields.select inputName="type" inputValue="{{old('type')}}" inputRequired="true" :options="$roleTypes" optionValueKey="id" optionLabelKey="title" labelText="Role Type" placeHolder="" /> 
                                        </div>
                                        <div class="col-xl-12">
                                            <x-form-fields.text-area inputName="short_desc" inputValue="{{old('short_desc')}}" inputRequired="false" labelText="Short Description" rows="4" cols="50" maxlength="255" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card permission-card">
                            ...
                            <div class="card-body">
                                <div id="permission-section">
                                    <div class="permission-container admin-permission">
                                        <x-users.roles.role-permission-area :permissions="$adminPermissions" />
                                    </div>
                                </div>
                            </div>
                        </div>
