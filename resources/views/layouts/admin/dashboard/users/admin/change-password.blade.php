...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <x-page-title header="Update Admin Password" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                ...
                                <x-breadcrumb-item active="true" url="{{ route('admin.users.admin.update-password', $user->id) }}" label="Update Admin Password" />
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    <x-form-fields.advanced.change-user-password action="{{ route('admin.users.admin.update-password', $user->id) }}"/>
@endsection
