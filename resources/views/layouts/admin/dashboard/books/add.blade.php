                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <x-page-title header="Add New Book" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                ...
                                <x-breadcrumb-item active="true" url="{{ route('admin.books.add') }}" label="Add New Book" />
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="digital-add needs-validation">
                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <x-form-fields.advanced.dropify
                                                ...
                                                multiple="true">
                                                <label class="form-label required" for="image_path">Book Image<span>*</span></label>
                                            </x-form-fields.advanced.dropify>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <x-form-fields.advanced.text-area
                                                ...
                                                inputValue="{{ old('short_description') }}"
                                                inputRequired=""
                    ...
                    <div class="col-xl-3">
                        <x-product-submission-card cardLabel="Publish" submitLabel="Save" draftLabel="Draft" discardLabel="Discard" />
                    </div>
                </div>
            </div>
        </div>
