...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <x-page-title header="Add New Coupon" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                ...
                                <x-breadcrumb-item active="true" url="{{ route('admin.coupon.add') }}" label="Add" />
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    <div class="">
        <div class="container-fluid">
            <form method="POST" action="{{ route('admin.coupon.store') }}" class="digital-add needs-validation" enctype="multipart/form-data">
                @csrf
                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-6" id="freeShippingAmount" style="display: none">
                                            <x-form-fields.number 
                                                ...
                                                inputValue="{{ old('free_shipping_min') }}" 
                                                inputRequired="true" 
                                                labelText="Amount" 
...
<script>
    ...
    $(document).ready(function() {
        ...
        // Append input field on selected Apply for end
