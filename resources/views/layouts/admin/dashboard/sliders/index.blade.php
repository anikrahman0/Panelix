                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <x-page-title header="Sliders" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                <x-breadcrumb-item url="{{ route('admin.dashboard') }}" label="Dashboard" icon="home" />
                                <x-breadcrumb-item active="true" url="{{ route('admin.sliders.index') }}" label="Slider Image" />
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('admin.sliders.add') }}" class="btn btn-primary mt-md-0 mt-2"> <i class="fas fa-plus"></i> Add New Slider</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(!empty($slider->images))
                                                <div class="row">
                                                    @foreach($slider->images->take(5) as $image)
                                                        <div class="col-lg-2 col-md-4 col-sm-6 gallery_id p-1">
                                                            <div class="mb-2">
                                                                <div class="upload-wrap pt-1">
                                                                    <div class="upload-images">
                                                                        <img alt="Slider Image" class="img-fluid rounded" src="{{ $cdn_url.'/'.$image->img_bg }}" width="60">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <td>{{ $slider->title }}</td>
                                        <td>
                                            @foreach($slider->images->take(1) as $sliderImage)
                                                {{ $sliderImage->link_type == 1 ? 'url' : '' }}
                                            @endforeach
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <x-action-buttons.delete
                                                :url="route('admin.sliders.delete', $slider->id)" 
                                                :isSuper="auth()->guard('admin')->user()->is_super == 1" 
                                                confirmationMessage="Do you really want to delete this slider?"
                                                permission="sliders"
                                            />
                                        </td>
                                    </tr>
