...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <x-page-title header="Update City" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                ...
                                <x-breadcrumb-item active="true" url="{{ route('admin.cities.edit', $id) }}" label="Update City" />
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    <div class="">
        <div class="container-fluid">
            <form method="POST" action="{{ route('admin.cities.update', $id) }}" class="digital-add needs-validation" enctype="multipart/form-data">
                @csrf
                <div class="row">
                        ...
                        <div class="card mb-3">
                            <div class="form-body">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            {{-- <x-form-fields.text-common inputType="text" inputName="name" inputValue="{{ old('name') ?? $city->name }}" inputRequired="true" labelText="City Name" pattern="" /> --}}
                                            <x-form-fields.advanced.text-common 
                                                inputType="text"
                                                inputName="name" 
                                                inputValue="{{ old('name') ?? $city->name }}" 
                                            ...
                                            {{-- <x-form-fields.select2-single inputName="country_id" inputValue="{{old('country_id', $city->state->country_id)}}" inputRequired="true" :options="$countries" optionValueKey="id" optionLabelKey="country_name" labelText="Country" /> --}}
                                            <x-form-fields.advanced.select2-single
                                                inputName="country_id"
                                                inputClass="form-control country_id"
                                                inputValidationID="country_id"
                                                hideValue=""
                                                inputValue="{{ old('country_id', $city->state->country_id) }}" 
                                                inputRequired="required" 
                                                :options="$countries" 
                                                hasChildren="false"
                                                optionValueKey="id" 
                                            ...
                                            {{-- <x-form-fields.select2-single inputName="state_id" inputValue="{{old('state_id', $city->state_id)}}" inputRequired="true" :options="$states" optionValueKey="id" optionLabelKey="name" labelText="State" /> --}}
                                            <x-form-fields.advanced.select2-single
                                                inputName="state_id"
                                                inputClass="form-control state_id"
                                                inputValidationID="state_id"
                                                hideValue=""
                                                inputValue="{{ old('state_id', $city->state_id) }}" 
                                                inputRequired="required" 
                                                :options="$states" 
                                                hasChildren="false"
                                                optionValueKey="id" 
