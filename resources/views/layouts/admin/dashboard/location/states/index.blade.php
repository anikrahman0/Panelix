                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <x-page-title header="States" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                <x-breadcrumb-item url="{{ route('admin.dashboard') }}" label="Dashboard" icon="home" />
                                <x-breadcrumb-item active="true" url="{{ route('admin.states.index') }}" label="States" />
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('admin.states.add') }}" class="btn btn-primary mt-md-0 mt-2"> <i class="fas fa-plus"></i> Add New State</a>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.states.delete', $state->id) }}" onclick="return confirm('Do you really want to delete this state?');">
                                                <i class="fa fa-trash bg-primary p-2 rounded" title="Delete"></i>
                                            </a> --}}
                                            <x-action-buttons.edit
                                                :url="route('admin.states.edit', $state->id)" 
                                                :isSuper="auth()->guard('admin')->user()->is_super == 1" 
                                                permission="state"
                                            />
                                            <!-- Example usage in a Blade view -->
                                            <x-action-buttons.delete
                                                :url="route('admin.states.delete', $state->id)" 
                                                :isSuper="auth()->guard('admin')->user()->is_super == 1" 
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center">No State Found</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
