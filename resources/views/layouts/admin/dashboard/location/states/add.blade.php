...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <x-page-title header="Add New State" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                ...
                                <x-breadcrumb-item active="true" url="{{ route('admin.states.add') }}" label="Add New State" />
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    <div class="">
        <div class="container-fluid">
            <form method="POST" action="{{ route('admin.states.store') }}" class="digital-add needs-validation" enctype="multipart/form-data">
                @csrf
                <div class="row">
                        ...
                        <div class="card mb-3">
                            <div class="form-body">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            {{-- <x-form-fields.text-common inputType="text" inputName="name" inputValue="{{old('name')}}" inputRequired="true" labelText="State Name" pattern="" /> --}}
                                            ...
                                            {{-- <x-form-fields.text-common inputType="text" inputName="abbreviation" inputValue="{{old('abbreviation')}}" inputRequired="true" labelText="Abbreviation" pattern="" /> --}}
                                            <x-form-fields.advanced.text-common 
                                                inputType="text"
                                                inputName="abbreviation" 
                                                inputValue="{{ old('abbreviation') }}" 
