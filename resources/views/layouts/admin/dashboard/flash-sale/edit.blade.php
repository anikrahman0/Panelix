...
@section('title', 'Update Flash Sale')
...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <x-page-title header="Update Flash Sale" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                ...
                                <x-breadcrumb-item active="true" url="{{ route('admin.flash-sale.edit', $flashSale->id) }}" label="Update" />
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    <div class="">
        <div class="container-fluid">
            <form method="POST" action="{{ route('admin.flash-sale.update', $flashSale->id) }}" class="digital-add needs-validation" enctype="multipart/form-data">
                @csrf
                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <x-form-fields.advanced.dropify
                                                ...
                                                @if(!empty($flashSale->image_path))
                                                    <div class="img-container">
                                                        <img src="{{ !empty($flashSale->image_path) ? $cdn_url.'/'.$flashSale->image_path : '' }}" class="img-fluid rounded my-2" width="100" height="80" />
                                                    </div>
                                                @endif
                                            </x-form-fields.advanced.dropify>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <x-form-fields.advanced.text-common
                                                inputType="text" 
                                                inputName="title" 
                                                inputValue="{{ old('title') ?? $flashSale->title }}"  
                                                inputRequired="required" 
                                                labelText="Title"
                                            ...
                                            <x-form-fields.advanced.ckeditor
                                                ...
                                                inputValue="{{ old('description') ?? $flashSale->description }}" 
                                                inputRequired="" 
                                                ...
                                                <div class="d-flex align-items-center mt-3">
                                                    <div class="form-check-inline">
                                                        <x-form-fields.radio-checkbox 
                                                            ...
                                                            inputID="amount" 
                                                            isChecked="{{ $flashSale->offer_type == 1 ? 'checked' : ''}}" 
                                                            inputType="radio" 
                                                    ...
                                                    <div class="form-check-inline">
                                                        <x-form-fields.radio-checkbox 
                                                            ...
                                                            inputClass="form-check-input me-3" 
                                                            inputID="percentage" 
                                                            isChecked="{{ $flashSale->offer_type == 2 ? 'checked' : ''}}" 
                                                            inputType="radio" 
                                                            inputName="offer_type" 
                                                            inputValue="2" 
                                                            inputRequired="false" 
                                        ...
                                        <div class="col-sm-6">
                                            <x-form-fields.number 
                                                ...
                                                inputValue="{{ old('offer_amount') ?? $flashSale->offer_amount }}" 
                                                inputRequired="true" 
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="d-flex align-items-center mt-3">
                                                    <div class="form-check-inline">
                                                        <x-form-fields.radio-checkbox 
                                                            ...
                                                            inputClass="form-check-input me-3" 
                                                            inputID="active" 
                                                            isChecked="{{ $flashSale->status == 1 ? 'checked' : ''}}" 
                                                            inputType="radio" 
                                                            inputName="status" 
                                                            inputValue="1" 
                                                            inputRequired="false" 
                                                    ...
                                                    <div class="form-check-inline">
                                                        <x-form-fields.radio-checkbox 
                                                            ...
                                                            inputClass="form-check-input me-3" 
                                                            inputID="inactive" 
                                                            isChecked="{{ $flashSale->status == 2 ? 'checked' : ''}}" 
                                                            inputType="radio" 
                                                            inputName="status" 
                                                            inputValue="2" 
                                                            inputRequired="false" 
                                        ...
                                        <div class="col-sm-6">
                                            <x-form-fields.date 
                                                inputType="date" 
                                                inputName="end_time" 
                                                inputValue="{{ old('end_time') ?? ($flashSale->end_time ? \Carbon\Carbon::parse($flashSale->end_time)->format('Y-m-d') : '') }}" 
                                                inputRequired="true" 
                                                labelText="End Time" 
                                                minValue="" 
                                                maxValue="" />
