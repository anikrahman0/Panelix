...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <x-page-title header="Edit Author" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                ...
                                <x-breadcrumb-item active="true" url="{{ route('admin.author.edit', $author->id) }}" label="Edit author" />
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    <div class="">
        <div class="container-fluid">
            <form method="POST" action="{{ route('admin.author.update', $author->id) }}" class="digital-add needs-validation" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                                    ...
                                    <div class="row">
                                            ...
                                            <x-form-fields.advanced.dropify
                                                ...
                                                @if(!empty($author->image_path))
                                                    <div class="img-container">
                                                        <img src="{{ !empty($author->image_path) ? $cdn_url.'/'.$author->image_path : '' }}" class="img-fluid rounded my-2" width="100" height="80" />
                                                    </div>
                                                @endif
                                            </x-form-fields.advanced.dropify>
                                        </div>
                                        <div class="col-sm-12">
                                            <x-form-fields.advanced.text-common
                                                inputType="text" 
                                                inputName="name" 
                                                inputValue="{{ old('name') ?? $author->name }}"  
                                        ...
                                        <div class="col-sm-12">
                                            <x-form-fields.advanced.text-common
                                                inputType="text" 
                                                inputName="en_name" 
                                                inputValue="{{ old('en_name') ?? $author->en_name }}"  
                                                inputRequired="" 
                                        ...
                                        <div class="col-sm-12">
                                            <x-form-fields.advanced.text-common
                                                inputType="text" 
                                                inputName="email" 
                                                inputValue="{{ old('email') ?? $author->email }}"  
                                                inputRequired="" 
                                        ...
                                        <div class="col-sm-12">
                                            <x-form-fields.advanced.text-common
                                                ...
                                                inputValue="{{ old('social_link_fb') ?? $author->social_link_fb }}" 
                                                inputRequired="" 
                                        ...
                                        <div class="col-sm-12">
                                            <x-form-fields.advanced.text-common
                                                ...
                                                inputValue="{{ old('social_link_x') ?? $author->social_link_x }}" 
                                                inputRequired="" 
                                        ...
                                        <div class="col-sm-12">
                                            <x-form-fields.advanced.text-common
                                                ...
                                                inputValue="{{ old('social_link_ig') ?? $author->social_link_ig }}" 
                                                inputRequired="" 
                                                ...
                                                <div class="d-flex align-items-center mt-3">
                                                    <div class="form-check-inline">
                                                        <x-form-fields.advanced.radio-checkbox 
                                                            ...
                                                            isChecked="{{ (old('status', $author->status) == 1) ? 'checked' : '' }}" 
                                                            inputType="radio" 
                                                            inputName="status" 
                                                            inputValue="1" 
                                                            inputRequired="" 
                                                    ...
                                                    <div class="form-check-inline">
                                                        <x-form-fields.advanced.radio-checkbox 
                                                            ...
                                                            isChecked="{{ (old('status', $author->status) == 2) ? 'checked' : '' }}" 
                                                            inputType="radio" 
                                                            inputName="status" 
                                                            inputValue="2" 
                                                            inputRequired="" 
