                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <x-page-title header="Parent Categories" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                <x-breadcrumb-item url="{{ route('admin.dashboard') }}" label="Dashboard" icon="home" />
                                <x-breadcrumb-item active="true" url="{{ route('admin.categories.index') }}" label="Parent Categories" />
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <div>
                                <a href="{{ route('admin.categories.add') }}" class="btn btn-primary mt-md-0 mt-2">
                                    <i class="fas fa-plus"></i> Add New Parent Category
                                </a>
                            </div>
                        </div>
                            ...
                            <form action="{{ route('admin.categories.index') }}" method="GET">
                                <div class="row">
                                    ...
                                    <div class="col-xl-2 col-lg-2 col-md-2">
                                        <a href="{{ route('admin.categories.index') }}" class="btn btn-sm reset-btn">
                        ...
                        <div class="d-flex justify-content-center mb-5">
							{!! $categories->appends(request()->query())->onEachSide(2)->links() !!}
                        </div>
                    </div>
                </div>
            </div>
