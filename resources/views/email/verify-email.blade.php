                                        ...
                                        <tbody>
                                            ...
                                            <tr bgcolor="#fb914b">
                                                <td colspan="2"
                                                    ...
                                                    <span
                                                        style=" font-family: arial, sans-serif; font-size: 16px; text-transform: capitalize; line-height: 24px; color:#fff; font-weight: bold;">Verify
                                                        Email Address</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                                                        ...
                                                                                        <tbody>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <div>
                                                                                                        <span
                                                                                                            style=" font:14px Arial, sans-serif; color: #333; line-height:20px; font-weight:600; color:#fb914b">
                                                                                                            Please click
                                                                                                            the button
                                                                                                            below to
                                                                                                            verify your
                                                                                            ...
                                                                                            <tr>
                                                                                                <td width="50%">
                                                                                                    <span
                                                                                                        ...
                                                                                                        <br>
                                                                                                        {{ $settings->site_title ?? config('app.default_site_title') }}</span>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td>
                                                                ...
                                                                <td width="50%" style="text-align: center;">
                                                                    <span
                                                                        ...
                                                                        by <a style="color:#fb914b; text-decoration: none;"
                                                                            ...
                                                                            target="_blank">{{ $settings->site_title ?? config('app.default_site_title') }}</a> .</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
